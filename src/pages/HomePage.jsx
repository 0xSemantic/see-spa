  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="font-display text-5xl font-light leading-tight mb-4" style={{ color: 'var(--spa-dark)' }}>
          Book Your<br />
          <em>Spa Experience</em>
        </h1>
        <p className="text-sm max-w-sm mx-auto leading-relaxed" style={{ color: 'var(--spa-muted)' }}>
          Treat yourself to a moment of pure relaxation. Our experts are ready to pamper you.
        </p>
      </div>

      {/* Booking card */}
      <div className="rounded-3xl p-8 shadow-sm" style={{ background: 'white', border: '1px solid rgba(199,233,192,0.4)' }}>
      ...
      <div className="mt-8 grid grid-cols-3 gap-4 text-center">
        {[
          ...
          <div key={item.label} className="py-4 rounded-2xl text-xs font-medium"
